  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 p-4 md:p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-800">Movimentações</h1>
          <p className="text-slate-500 mt-1">Histórico de entradas e saídas</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-slate-600">Nenhuma movimentação</h3>
                    ...
                    return (
                      <div key={movement.id} className="flex items-center gap-4 p-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-slate-800">{movement.product_name}</p>
